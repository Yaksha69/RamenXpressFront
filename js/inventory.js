...
const API_URL = 'https://ramenb.onrender.com/api/v1/inventory/all';
const CREATE_URL = 'https://ramenb.onrender.com/api/v1/inventory/create';
const UPDATE_URL = 'https://ramenb.onrender.com/api/v1/inventory/update/';
const DELETE_URL = 'https://ramenb.onrender.com/api/v1/inventory/delete/';
const ADD_MENU_URL = 'https://ramenb.onrender.com/api/v1/menu/newMenu';
...
async function openEditModal(id) {
  ...
  try {
            const res = await fetch(`https://ramenb.onrender.com/api/v1/inventory/${id}`, {
